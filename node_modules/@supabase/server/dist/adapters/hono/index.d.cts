import { g as UntypedDatabase, m as SupabaseContext, v as WithSupabaseConfig } from "../../types-oyagyAIH.cjs";
 ...
 * @category Adapters
 */
declare function withSupabase<Database = UntypedDatabase>(config?: Omit<WithSupabaseConfig, 'cors'>): MiddlewareHandler<{
  Variables: {
